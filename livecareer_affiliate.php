...
/*
	...
	Author: LiveCareer
	Version: 1.2
	Author URI: https://www.livecareer.com
	License: GPL
...
class LiveCareerAffiliateSettingsPage
{
	...
	<p>Enter your referrer ID below in order to receive credit 
		...
		<a href="http://member.impactradius.com/campaign-mediapartner-signup/Live-Career.brand?type=dm" target="_blank">http://member.impactradius.com/campaign-mediapartner-signup/Live-Career.brand?type=dm</a>.
	</p>
...
END_PluginHelpSectionText;
	...
	{
		return '<iframe src="https://resume.livecareer.com/builder/iframebuilder-partner.aspx?ref=' . $ref_id . '" frameborder="0" height="1000px" width="980px"></iframe>';
	}
 ...
 */
 ...
 class wp_livecareer_affiliate_widget extends WP_Widget {
	...
	function wp_livecareer_affiliate_widget() {
		...
		$control_ops = array();
		parent::__construct(false, $name = __('LiveCareer Affiliate Widget', 'wp_widget_plugin'), $widget_ops, $control_ops );
	}
	...
	function widget($args, $instance) {
		...
		{
			case '300x250':
				$image_url = '<img src="https://www.livecareer.com/images/uploaded/plugins/300x250.jpg" border="0" width="300" height="250" alt="Click to build your resume">';
				break;
			case '160x600':
				$image_url = '<img src="https://www.livecareer.com/images/uploaded/plugins/160x600.jpg" border="0" width="160" height="600" alt="Click to build your resume">';
				break;
			default:
				//728x90
				$image_url = '<img src="https://www.livecareer.com/images/uploaded/plugins/728x90.jpg" border="0" width="728" height="90" alt="Click to build your resume">';
				break;
		}
		...
		echo '<a href="https://resume.livecareer.com/builder/iframebuilder-partner.aspx?ref=' . $ref_id . '&TB_iframe=true&width=1000&height=600" class="thickbox">' . $image_url . '</a>';
